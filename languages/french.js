...
module.exports = class {
    constructor() {
		this.language = {
			...
			CALC_ERROR: `${e.error} | Entrez un calcul valide !`,
			// Content
			...
			// Utils
			DOG_DESCRIPTION: "Affiche une image de chien :)",
			DOG_USAGE: "dog",
			DOG_EXAMPLES: "$dog",
			DOG_HEADERS: "Image de chien :dog: :",
			/* DUCK COMMAND */

			// Utils
			DUCK_DESCRIPTION: "Affiche une image de canard",
			DUCK_USAGE: "duck",
			DUCK_EXAMPLES: "$duck",
			/* FOX COMMAND */

			// Utils
			FOX_DESCRIPTION: "Affiche une image de renard",
			FOX_USAGE: "fox",
			FOX_EXAMPLES: "$fox",
			/* BIRD COMMAND */

			// Utils
			BIRD_DESCRIPTION: "Affiche une image d'oiseau",
			BIRD_USAGE: "bird",
			BIRD_EXAMPLES: "$bird",
			/* SHIBA COMMAND */

			// Utils
			SHIBA_DESCRIPTION: "Affiche une image de shiba",
			SHIBA_USAGE: "shiba",
			SHIBA_EXAMPLES: "$shiba",
			/* KISS COMMAND */

			// Utils
			KISS_DESCRIPTION: "Donne un bisou à l'utilisateur mentionné",
			KISS_USAGE: "kiss [mention]",
			KISS_EXAMPLES: "$kiss @truc",
			KISS_HEADER: ` fait un bisou à`,
			KISS_ERROR: ":x: | Veuillez mentionner un utilisateur",

			// Utils
			HIT_DESCRIPTION: "Donne un coup à l'utilisateur mentionné",
			HIT_USAGE: "hit [mention]",
			HIT_EXAMPLES: "$hit @truc",
			HIT_HEADER: ` donne un coup à`,
			HIT_ERROR: ":x: | Veuillez mentionner un utilisateur",

...
module.exports = class {
    constructor() {
		this.language = {
			...
			/* DOG COMMAND */
			DOG_DESCRIPTION: "Displays a dog image :)",
			DOG_USAGE: "dog",
			DOG_EXAMPLES: "$dog",
			DOG_HEADERS: "Displays of dog :dog: :",

			/* CAT COMMAND */
			CAT_DESCRIPTION: "Displays a cat image :)",
			CAT_USAGE: "cat",
			CAT_EXAMPLES: "$cat",
			CAT_HEADERS: "Displays of cat :cat: :",
			/* DUCK COMMAND */

			// Utils
			DUCK_DESCRIPTION: "Displays a duck image",
			DUCK_USAGE: "duck",
			DUCK_EXAMPLES: "$duck",
			/* FOX COMMAND */

			// Utils
			FOX_DESCRIPTION: "Displays a fox image",
			FOX_USAGE: "fox",
			FOX_EXAMPLES: "$fox",
			/* BIRD COMMAND */

			// Utils
			BIRD_DESCRIPTION: "Displays a bird image",
			BIRD_USAGE: "bird",
			BIRD_EXAMPLES: "$bird",
			/* SHIBA COMMAND */

			// Utils
			SHIBA_DESCRIPTION: "Displays a shiba image",
			SHIBA_USAGE: "shiba",
			SHIBA_EXAMPLES: "$shiba",

			KISS_DESCRIPTION: "Give a kiss of mentionned user",
			KISS_USAGE: "kiss [mention]",
			KISS_EXAMPLES: "$kiss @things",
			KISS_HEADER: ` kiss`,
			KISS_ERROR: ":x: | Please mention a user",

			// Utils
			HIT_DESCRIPTION: "Give a hit of mentionned user",
			HIT_USAGE: "hit [mention]",
			HIT_EXAMPLES: "$hit @things",
			HIT_HEADER: ` donne un coup à`,
			HIT_ERROR: ":x: | Please mention a user",
